...
import { Divider, Modifiers, Text, Stack } from '@jsxui/react'

// based on: https://play.tailwindcss.com/xTOjz3kR3m?file=config
...
function Code(props) {
  ...
  // return (
  //   <Stack inline space="2px" background="grey">
  //     <Text as="code" {...props} />
  //   </Stack>
  // )
}
      ...
      <Stack axis="x" spaceX="1fr" spaceY="64px">
        <Stack width="80%" spaceBetween={48}>
          ...
          <Text modifiers="body">
            ...
            <Text italic>awesome</Text>, not awful.
          </Text>
          <Text modifiers="body">
            The <Code>@tailwindcss/typography</Code> plugin is our attempt to
            give you what you <Text italic>actually</Text> want, without any of
            the downsides of doing something stupid like disabling our base
            styles.
          </Text>
          <Divider />
          <Text modifiers="heading2">What to expect from here on out</Text>
          <Text modifiers="body">
            ...
            <Text weight={700}>bold text</Text>, unordered lists, ordered lists,
            code blocks, block quotes, <Text italic>and even italics</Text>.
          </Text>
          <Text modifiers="body">
          ...
          <figure>
            <Image source="https://images.unsplash.com/photo-1556740758-90de374c12ad?ixlib=rb-1.2.1&amp;ixid=eyJhcHBfaWQiOjEyMDd9&amp;auto=format&amp;fit=crop&amp;w=1000&amp;q=80" />
            <Text as="figcaption">
